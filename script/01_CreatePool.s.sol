...
contract CreatePoolScript is Script {
    ...
    function run() external {
        ...
        // floor(sqrt(1) * 2^96)
        uint160 startingPrice = 79228162514264337593543950336; // 1:1

        // NOTE: Hookless pool doesn require any initilization data.
        bytes memory hookData = abi.encode(block.timestamp); // Data to pass to the hook
